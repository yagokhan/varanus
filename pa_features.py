...
NOTE: detect_mss() uses center=True rolling (requires future bars).
      This is correct for training/backtesting.  The live scanner will
      use detect_mss_live() (trailing window) in a later step.
"""
...
def build_features(
    ...
    """
    Compute all 16 PA + confirmation features for a single asset.
    ...
    # Keep only the 16 feature columns
