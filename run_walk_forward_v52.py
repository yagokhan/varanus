#!/usr/bin/env python3
"""
run_walk_forward_v52.py — Varanus v5.2 Dual-Engine Walk-Forward Validation
Validates optimized best_params_v52.json across 5-fold rolling OOS windows.
...
def run():
    print("=" * 60)
    print("  Varanus v5.2 Dual-Engine — Walk-Forward Validation")
    ...
    # Save results
    out_csv = _HERE / "varanus" / "config" / "wfv_v52_results.csv"
