    ...
    def scan(self) -> list[dict]:
        ...
        for asset in TIER2_UNIVERSE:
            ...
            try:
                ...
                # TBM barriers — direction-specific (Short: v5.1 params, Long: v5.2 Long Runner)
                ...
                if direction == -1:
                    ...
                    tbm_cfg["take_profit_atr"] = self.params.get("tp_mult_long", 2.848)
                    tbm_cfg["stop_loss_atr"]   = self.params.get("sl_mult_long", 0.882)
